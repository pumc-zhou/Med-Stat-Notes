...
在新电脑中，使用conda配置python解释器后，具体路径在：

``` bash
C:\Software\miniconda3\envs\work311\Lib\site-packages\saspy\sascfg.py
```
...
``` python
(base) PS C:\Users\zhou> conda install saspy
...
## Package Plan ##
  ...
  environment location: C:\Software\miniconda3
...
The following packages will be downloaded:
    ...
    saspy-5.102.1              |   py39haa95532_0         9.3 MB
    ------------------------------------------------------------
                                           Total:         9.4 MB

The following NEW packages will be INSTALLED:

  saspy              pkgs/main/win-64::saspy-5.102.1-py39haa95532_0

The following packages will be UPDATED:

  ca-certificates                       2025.9.9-haa95532_0 --> 2025.12.2-haa95532_0
